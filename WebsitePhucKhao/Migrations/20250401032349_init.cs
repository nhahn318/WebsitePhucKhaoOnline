        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BangDiems_HocKys_MaHocKy",
                        column: x => x.MaHocKy,
                        principalTable: "HocKys",
                        principalColumn: "MaHocKy");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_BangDiems_NamHocs_MaNamHoc",
                        column: x => x.MaNamHoc,
                        principalTable: "NamHocs",
                        principalColumn: "MaNamHoc");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_DonPhucKhaos_HocKys_MaHocKy",
                        column: x => x.MaHocKy,
                        principalTable: "HocKys",
                        principalColumn: "MaHocKy",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DonPhucKhaoChiTiets_GiangViens_MaGiangVien",
                        column: x => x.MaGiangVien,
                        principalTable: "GiangViens",
                        principalColumn: "MaGiangVien",
                        onDelete: ReferentialAction.SetNull);
